...
install.packages("ggplot2") # grifik cizmez icin
...
#vericekimi####
#tuber paketi ile
#myclientid="144377970441-slafghhu859p463v08j29sbfhi41ibup.apps.googleusercontent.com"
#myclientsecret="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"
